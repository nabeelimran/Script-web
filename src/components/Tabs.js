...
function Tabs({ pastShows, currentShows, tabsOptions }) {
        ...
        {tabsOptions && tabsOptions.length > 0
          ? tabsOptions.map((option, index) => (
              ...
              >
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  currentShows.length > 0
                    ? currentShows.map((show, index) => (
                        <ChannelShowCard show={show} key={index} />
                      ))
                    : null}
                </div>
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {option.tagIdLabel === "pastPrograms" &&
                  pastShows &&
                  pastShows.length > 0
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {option.tagIdLabel === "about" ? (
                    <div>
                      <div className="mb-6">
                        <h2 className="text-2xl mb-3">Genre</h2>
                        <div className="flex">
                          <span className="border-box border border-[#3c58ee] mr-3 rounded-md py-2 px-3 inline-block">
                            Entertainment
                          </span>
                          <span className="border-box border border-[#3c58ee] mr-3 rounded-md py-2 px-3 inline-block">
                            Movies
                      ...
                      <div className="mb-6">
                        <h2 className="text-2xl mb-1.5">Description</h2>
                        <p>Enjoy shows here</p>
                      </div>
