      ...
      <div className="container-two mb-20">
        ...
        <div className="dictator-content">
          <div class="dictator-section">
            <h4 class="dictator-title">1. About the Website</h4>
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">2. Acceptance of the Terms</h4>
            <p class="dictator-desc">
            ...
            <p class="ml-5 dictator-desc">(A) These Terms and Conditions</p>
            <p class="ml-5 dictator-desc">(B) Our Privacy Policy</p>
            <p class="ml-5 dictator-desc">(C) Our Cookie Policy</p>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">3. Registration to use the Services</h4>
            <p class="dictator-desc">
            ...
            <p class="ml-5 dictator-desc">(A) an email address</p>
            <p class="ml-5 dictator-desc">(B) a mailing address</p>
            <p class="ml-5 dictator-desc">(C) a password</p>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">4. Your obligations as a User</h4>
            <p class="dictator-desc">
            ...
            <p class="ml-5 dictator-desc">(i) he Terms; and</p>
            <p class="ml-5 dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">5. The Services</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">6. Third-Party Service and Content</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">8. Privacy</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">9. General Disclaimer</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">10. Limitation of liability</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">11. Termination of Contract</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">12. Indemnity</h4>
            <p class="dictator-desc">
            ...
            <p class="ml-5 dictator-desc">(C) any breach of the Terms.</p>
          </div>
          <div class="dictator-section">
            <h4 class="dictator-title">13. Dispute Resolution</h4>
            <p class="dictator-desc">13.1. Compulsory:</p>
            <p class="dictator-desc">
            ...
            <p class="dictator-desc">13.2. Notice:</p>
            <p class="dictator-desc">
            ...
            <p class="dictator-desc">13.3. Resolution:</p>
            <p class="dictator-desc">
            ...
            <p class="dictator-desc">13.4. Confidential</p>
            <p class="dictator-desc">
            ...
            <p class="dictator-desc">13.5. Termination of Mediation:</p>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">14. Venue and Jurisdiction</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">15. Governing Law</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">16. Independent Legal Advice</h4>
            <p class="dictator-desc">
          ...
          <div class="dictator-section">
            <h4 class="dictator-title">17. Severance</h4>
            <p class="dictator-desc">
