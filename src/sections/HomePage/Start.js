    ...
    <section>
      <div className="container grid md:grid-cols-[.8fr_1fr] gap-8 md:gap-20">
        <div className="border-b-2 border-primary pb-6">
          <h1 className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl text-white font-bold">
            <span className="text-primary">Start in</span> Seconds
          </h1>
        </div>
        <div>
          <p className="text-base md:text-lg xl:text-xl text-white font-medium mb-4 md:mb-5 xl:mb-8">
            Head to our app, sign up, and start watching tv with rewards within
            seconds.
          </p>
          <p className="text-base md:text-lg xl:text-xl text-white font-medium mb-6 xl:mb-10">
          ...
          <a
            href="/"
            className="w-fit text-base md:text-lg flex items-center space-x-2 mb-8 xl:mb-12"
          >
