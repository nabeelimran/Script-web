  ...
  return (
    <section>
      <div className="container grid md:grid-cols-[.8fr_1fr] gap-8 md:gap-20">
        ...
        <div>
          <p className="fs-16px md:text-lg xl:text-xl text-white font-medium mb-4 md:mb-5 xl:mb-8">
            Head to our app, sign up, and start watching tv with rewards within
            seconds.
          </p>
          <p className="fs-16px md:text-lg xl:text-xl text-white font-medium mb-6 xl:mb-10">
          ...
          <a
            href="/"
            className="w-fit fs-16px md:text-lg flex items-center space-x-2 mb-8 xl:mb-12"
          >
