    ...
    <div className="flex items-center space-x-4">
      ...
      <div>
        <div className="flex items-center space-x-2 mb-1">
          <p className="font-medium fs-16px lh-1">Mystery Arts</p>
          <img src="images/verified.svg" className="w-[14px]" alt="" />
        </div>

        <div className="flex items-center space-x-2">
          <a href="/" className="text-blue-link text-sm">
            0x53hr43...H53h
          </a>
...
const Owner = () => {
  return (
    <div className="flex items-center space-x-4">
      ...
      <div>
        <p className="text-white text-base mb-1 lh-1">Owner</p>
        <p className="text-sm text-primary font-medium">0x53hr43...H53h</p>
      </div>
    </div>
  );
};
    ...
    <div className="border-1px border-[#1F1F1F] rounded-lg py-3 px-5">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button
          ...
          customizationClassName="px-6 rounded-lg font-semibold"
        />
      </div>
