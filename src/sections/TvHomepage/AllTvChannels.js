...
function AllTvChannels({
  ...
  const createShareButton = () => {
    ...
    if (controlEl && controlEl.length > 0) {
      let childNodes =
        document.getElementsByClassName("vjs-control-bar")[0].childNodes;
      ...
      playerRef.current.on("play", () => {
        ...
        videoWatchInterval = setInterval(() => {
          const videoWatchTime = {
            ...
            videoPlayTime:
              (new Date().getTime() - new Date(show.startTime).getTime()) /
              1000,
          };
          ...
          >
            ...
            >
              ...
              <div
                ...
                ref={showchatRef}
              >
                <button className="t ext-2xl" onClick={chatDisplayHandler}>
                  <Icon
            ...
            <div className="sm:py-5 sm:px-8 lg:px-0" ref={hidechatRef}>
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-4">
                  <button className="text-2xl" onClick={chatHideHandler}>
                    <Icon
                      icon="material-symbols:arrow-right-alt-rounded"
                      className="rotate-180"
                    />
